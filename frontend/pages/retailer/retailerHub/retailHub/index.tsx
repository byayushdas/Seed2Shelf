...
export default function RetailHubPage() {
  ...
  // Filter state for My Inventory (Primary Tabs: Retailed Products, Purchased Harvests)
  const [inventoryFilter, setInventoryFilter] = useState<"RETAILED" | "RAW">("RETAILED");
